  ...
  items: {
    'portfolio-indicators': {
      ...
      capabilities: [
        ...
        { title: '导出到对话,再变成幻灯片', body: '把面板视图发进一个对话,一键变成 PowerPoint 或 Excel —— 指标判断成为可分享的成果。' },
        { title: '用链接只读分享', body: '用一个 URL 分享实时持仓视图 —— 持仓、信号和轨迹一并呈现 —— 查看者无需注册账号。' },
      ],
      howItWorks: [
        { step: '添加你的持仓', detail: '建立一个美股、港股或 A股代码的组合 —— 或导入一份自选股。' },
        { step: '阅读信号 + 轨迹', detail: '打开指标面板。每只持仓都展示全部 8 个维度以及 5 天分档轨迹。' },
        { step: '用多信号视图过滤', detail: '用 ADX 作为趋势状态过滤器,MACD/RSI/KDJ 作为触发器,成交量 + 资金流作为确认。' },
        { step: '导出或分享', detail: '把判断变成幻灯片/Excel,或分享一个只读链接征求第二意见。' },
      ],
      faq: [
    ...
    'research-documents': {
      ...
      faq: [
        ...
        { q: '我能生成多少个文件?', a: '取决于套餐:Free 每月 2 个,Starter 8 个,Pro 30 个,Power 100+ 个。无论何种套餐,文件生成始终使用 Advanced AI 模型,因此产出质量保持很高。下载链接保留 7 天。' },
      ],
    },
    'ai-analyst': {
      eyebrow: '研究',
      ...
      capabilities: [
        ...
        { title: '长期记忆', body: '跨会话记住你的投资逻辑、自选股和偏好,让你接着上次继续,而不必每次都重新解释上下文。' },
      ...
      faq: [
        ...
        { q: '"记忆"到底记住什么?', a: '你的投资逻辑、自选股、偏好,以及此前的对话上下文 —— 跨会话留存,并限定在你的账号范围内。你可以查看和编辑记忆条目,而且在每种套餐上都不限量。' },
...
export const pricing: PricingContent = {
  ...
  metaDescription:
    'PickSkill 套餐:Free、Starter $15/月、Pro $39/月、Power $129/月。年付立省 20%。7 天 Pro 试用,无需绑卡。随时取消。',
  heroEyebrow: '套餐与价格',
  heroHeadline: '一位 AI 分析师,只要几杯咖啡的价钱。',
  heroSub:
    '用大白话研究、建模、起草股票投研工作。年付套餐立省 20%。每个新账号都享 7 天 Pro 试用 —— 无需绑卡。',
  perMonth: '/月',
  mostPopular: '最受欢迎',
  everyPlanNote:
  ...
  faq: [
    { q: 'Pro 有免费试用吗?', a: '每个新账号在注册时都享 7 天完整的 Pro 权限 —— 无需信用卡。试用结束后,你可以选择套餐,或继续留在 Free。' },
    { q: '一次"对话"怎么算?', a: '围绕一个主题与 AI 的一来一回 —— 包括该线程内的追问和工具调用。我们把整个线程算作一次对话,计入你的月度额度。' },
    { q: '文件生成如何运作?', a: '让 AI 做一个 PowerPoint、Word 或 Excel 文件。我们生成它,托管在 Cloudflare R2 上,并在对话中给你一个 7 天有效的下载链接。无论篇幅长短,每个文件计为一个额度,并始终使用 Advanced AI 模型。' },
