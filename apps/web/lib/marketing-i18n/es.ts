  ...
  items: {
    'portfolio-indicators': {
      ...
      capabilities: [
        ...
        { title: 'Exporta al chat y luego a una presentación', body: 'Envía la vista del panel a un chat y conviértela en un PowerPoint o un Excel con un solo clic: la lectura de los indicadores se convierte en un artefacto que puedes compartir.' },
        { title: 'Comparte en modo solo lectura con un enlace', body: 'Comparte una vista de cartera en vivo con una sola URL (posiciones, señales y el rastro), sin que el visor necesite cuenta.' },
      ],
      howItWorks: [
        { step: 'Añade tus posiciones', detail: 'Crea una cartera con tickers de EE. UU., Hong Kong o acciones A, o importa una lista de seguimiento.' },
        ...
        { step: 'Exporta o comparte', detail: 'Convierte la lectura en una presentación o un Excel, o comparte un enlace de solo lectura para una segunda opinión.' },
      ],
      faq: [
    ...
    'research-documents': {
      ...
      faq: [
        ...
        { q: '¿Cuántos archivos puedo generar?', a: 'Depende del plan: Free 2/mes, Starter 8, Pro 30, Power 100+. La generación de archivos siempre usa el modelo de IA Avanzado, independientemente del plan, para que la calidad del resultado se mantenga alta. Los enlaces de descarga se conservan durante 7 días.' },
      ],
    },
    'ai-analyst': {
      ...
      capabilities: [
        ...
        { title: 'Memoria a largo plazo', body: 'Recuerda tu tesis, tu lista de seguimiento y tus preferencias entre sesiones, para que retomes donde lo dejaste en lugar de volver a explicar el contexto cada vez.' },
      ...
      faq: [
        ...
        { q: '¿Qué recuerda realmente la «memoria»?', a: 'Tu tesis de inversión, tu lista de seguimiento, tus preferencias y el contexto de conversaciones previas, persistidos entre sesiones y limitados a tu cuenta. Puedes revisar y editar las entradas de memoria, y son ilimitadas en todos los planes.' },
...
export const pricing: PricingContent = {
  ...
  metaDescription:
    'Planes de PickSkill: Free, Starter $15/mes, Pro $39/mes, Power $129/mes. La facturación anual ahorra un 20 %. Prueba Pro de 7 días, sin tarjeta. Cancela cuando quieras.',
  heroEyebrow: 'Planes y precios',
  heroHeadline: 'Un analista con IA por el precio de unos cafés.',
  heroSub:
    'Investiga, modela y redacta trabajo de renta variable en lenguaje natural. Los planes anuales ahorran un 20 %. Cada cuenta nueva obtiene una prueba Pro de 7 días, sin tarjeta.',
  perMonth: '/mes',
  ...
  plans: {
    ...
    starter: {
      ...
      features: [
        ...
        '8 archivos / mes',
        '1 lista de seguimiento · hasta 20 símbolos',
        'Soporte por correo en menos de 48 h',
      ],
    },
    pro: {
      ...
      features: [
        ...
        '30 archivos / mes',
        'Actualización automática de cotizaciones cada 15 min',
        'Exporta el panel a una presentación',
        'Soporte por correo en menos de 24 h',
      ],
    },
    power: {
      ...
      features: [
        ...
        '100+ archivos / mes',
        'Cotizaciones en tiempo real bajo demanda (auto cada 5 min)',
        'Exportaciones de panel ilimitadas',
        'Soporte por canal de Slack compartido',
      ],
    },
  },
  faq: [
    { q: '¿Hay una prueba gratuita de Pro?', a: 'Cada cuenta nueva obtiene 7 días de acceso completo a Pro al registrarse, sin tarjeta de crédito. Tras la prueba, eliges tu plan o te quedas en Free.' },
    ...
    { q: '¿Cómo funciona la generación de archivos?', a: 'Pídele a la IA que cree un archivo de PowerPoint, Word o Excel. Lo generamos, lo alojamos en Cloudflare R2 y te damos un enlace de descarga válido durante 7 días en el chat. Cada archivo cuenta como uno frente a tu cuota mensual, independientemente de su longitud, y siempre usa el modelo de IA Avanzado.' },
