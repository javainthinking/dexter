  ...
  items: {
    'portfolio-indicators': {
      ...
      capabilities: [
        ...
        { title: '匯出到對話,再做成簡報', body: '把儀表板畫面送進對話,一鍵變成 PowerPoint 或 Excel —— 讓指標判讀成為可分享的成品。' },
        { title: '用連結唯讀分享', body: '用一個網址分享即時的投資組合畫面 —— 持股、訊號與軌跡 —— 觀看者無需註冊帳號。' },
      ],
      howItWorks: [
        { step: '加入你的持股', detail: '建立一個由美股、港股或 A股 代碼組成的投資組合 —— 或匯入一份觀察清單。' },
        ...
        { step: '匯出或分享', detail: '把判讀做成簡報/Excel,或分享一個唯讀連結徵詢第二意見。' },
      ],
      faq: [
    ...
    'research-documents': {
      ...
      faq: [
        ...
        { q: '我可以生成幾個檔案?', a: '視方案而定:Free 每月 2 個、Starter 8 個、Pro 30 個、Power 100+ 個。檔案生成一律使用 Advanced AI 模型,不論方案為何,因此輸出品質維持高水準。下載連結保留 7 天。' },
      ],
    },
    'ai-analyst': {
      eyebrow: '研究',
      ...
      capabilities: [
        ...
        { title: '長期記憶', body: '跨工作階段記住你的論點、觀察清單與偏好,讓你從上次中斷處接續,而不必每次都重新解釋來龍去脈。' },
      ...
      faq: [
        ...
        { q: '「記憶」實際上記住什麼?', a: '你的投資論點、觀察清單、偏好,以及先前的對話脈絡 —— 跨工作階段保留,並限定於你的帳號範圍內。你可以檢視並編輯記憶項目,且所有方案皆無上限。' },
...
export const pricing: PricingContent = {
  ...
  metaDescription:
    'PickSkill 方案:Free、Starter $15/月、Pro $39/月、Power $129/月。年繳省 20%。7 天 Pro 試用,無需信用卡。隨時可取消。',
  heroEyebrow: '方案與定價',
  heroHeadline: '一位 AI 分析師,只要幾杯咖啡的價格。',
  heroSub:
    '用白話研究、建模並撰寫個股工作。年繳方案省 20%。每個新帳號都享有 7 天 Pro 試用 —— 無需信用卡。',
  perMonth: '/月',
  mostPopular: '最受歡迎',
  everyPlanNote:
  ...
  faq: [
    { q: '有 Pro 的免費試用嗎?', a: '每個新帳號在註冊時都享有 7 天的完整 Pro 存取 —— 無需信用卡。試用結束後,你可以選擇方案或繼續使用 Free。' },
    { q: '一次「對話」如何計算?', a: '與 AI 針對某個主題的一段來回對話串 —— 包含該對話串內的後續追問與工具呼叫。我們把整段對話串算作一次對話,計入你的每月額度。' },
    { q: '檔案生成如何運作?', a: '請 AI 製作一個 PowerPoint、Word 或 Excel 檔案。我們會生成它、託管於 Cloudflare R2,並在對話中給你一個 7 天有效的下載連結。每個檔案不論長度都算作每月額度中的一個,且一律使用 Advanced AI 模型。' },
