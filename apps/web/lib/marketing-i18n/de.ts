  ...
  items: {
    'portfolio-indicators': {
      ...
      capabilities: [
        ...
        { title: 'In den Chat exportieren, dann ins Deck', body: 'Senden Sie die Dashboard-Ansicht in einen Chat und verwandeln Sie sie mit einem Klick in eine PowerPoint oder Excel — die Indikator-Analyse wird zum teilbaren Artefakt.' },
        { title: 'Schreibgeschützt per Link teilen', body: 'Teilen Sie eine Live-Portfolio-Ansicht über eine einzige URL — Positionen, Signale und den Verlauf — ganz ohne Konto für den Betrachter.' },
      ],
      howItWorks: [
        { step: 'Positionen hinzufügen', detail: 'Bauen Sie ein Portfolio aus US-, HK- oder A-Aktien-Tickern — oder importieren Sie eine Watchlist.' },
        ...
        { step: 'Exportieren oder teilen', detail: 'Verwandeln Sie die Analyse in ein Deck oder Excel oder teilen Sie einen schreibgeschützten Link für eine zweite Meinung.' },
      ],
      faq: [
    ...
    'research-documents': {
      ...
      faq: [
        ...
        { q: 'Wie viele Dateien kann ich generieren?', a: 'Je nach Tarif: Free 2/Monat, Starter 8, Pro 30, Power 100+. Die Datei-Generierung nutzt unabhängig vom Tarif stets das Advanced-AI-Modell, sodass die Ausgabequalität hoch bleibt. Download-Links bleiben 7 Tage erhalten.' },
      ],
    },
    'ai-analyst': {
      eyebrow: 'Research',
      ...
      capabilities: [
        ...
        { title: 'Langzeitgedächtnis', body: 'Merkt sich Ihre These, Watchlist und Präferenzen über Sitzungen hinweg, sodass Sie dort weitermachen, wo Sie aufgehört haben, statt jedes Mal den Kontext neu zu erklären.' },
      ...
      faq: [
        ...
        { q: 'Was merkt sich das „Gedächtnis" tatsächlich?', a: 'Ihre Investmentthese, Watchlist, Präferenzen und den bisherigen Gesprächskontext — über Sitzungen hinweg gespeichert und auf Ihr Konto beschränkt. Sie können Gedächtniseinträge einsehen und bearbeiten, und sie sind in jedem Tarif unbegrenzt.' },
...
export const pricing: PricingContent = {
  ...
  metaDescription:
    'PickSkill-Tarife: Free, Starter $15/Mon., Pro $39/Mon., Power $129/Mon. Jährliche Abrechnung spart 20%. 7-tägige Pro-Testphase, ohne Karte. Jederzeit kündbar.',
  heroEyebrow: 'Tarife & Preise',
  heroHeadline: 'Ein AI-Analyst zum Preis von ein paar Kaffees.',
  heroSub:
    'Recherchieren, modellieren und entwerfen Sie Aktienanalysen in verständlichem Deutsch. Jahrestarife sparen 20%. Jedes neue Konto erhält eine 7-tägige Pro-Testphase — ohne Karte.',
  perMonth: '/Mon.',
  ...
  plans: {
    free: {
      ...
      features: [
        ...
        '2 Dateien / Monat (PPT / Word / Excel)',
    ...
    pro: {
      ...
      features: [
        ...
        '30 Dateien / Monat',
        'Automatische Kursaktualisierung alle 15 Min.',
        'Dashboard in ein Deck exportieren',
    ...
    power: {
      ...
      features: [
        ...
        '100+ Dateien / Monat',
        'Echtzeitkurse auf Abruf (5-Min.-Automatik)',
        'Unbegrenzte Dashboard-Exporte',
        'Support über einen gemeinsamen Slack-Kanal',
      ],
    },
  },
  faq: [
    { q: 'Gibt es eine kostenlose Pro-Testphase?', a: 'Jedes neue Konto erhält bei der Anmeldung 7 Tage vollen Pro-Zugang — ohne Kreditkarte. Nach der Testphase wählen Sie Ihren Tarif oder bleiben bei Free.' },
    ...
    { q: 'Wie funktioniert die Datei-Generierung?', a: 'Bitten Sie die AI, eine PowerPoint-, Word- oder Excel-Datei zu erstellen. Wir generieren sie, hosten sie auf Cloudflare R2 und geben Ihnen einen 7-Tage-Download-Link im Chat. Jede Datei zählt unabhängig von ihrer Länge als eine auf Ihr Monatskontingent und nutzt stets das Advanced-AI-Modell.' },
